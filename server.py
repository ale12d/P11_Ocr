...
def purchasePlaces():
    ...
    elif placesRequired > MAX_PLACES_COMPETITION:
        flash(f'incorrect input / places cannot be higher than {MAX_PLACES_COMPETITION} ')
    else:
        club["points"] = placesAllowed - placesRequired
...
@app.route('/showClubsPoints', methods=['GET'])
def points_display():
